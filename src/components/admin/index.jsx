    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="pt-32 px-6 flex justify-center">
        <div className="max-w-3xl w-full">
          <h2 className="text-xl font-semibold mb-5 text-customBlue text-center">Welcome to Admin Dashboard</h2>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <button
              ...
              className="bg-gray-600 text-white px-4 py-2 rounded hover:bg-customBlue"
            >
              Edit Password
            </button>
          </div>
